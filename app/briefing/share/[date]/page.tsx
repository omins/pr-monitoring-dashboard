...
import { TrendingUp, TrendingDown, Newspaper, Globe, ExternalLink, Copy } from "lucide-react"
import { Button } from "@/components/ui/button"
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card"
import { Badge } from "@/components/ui/badge"
import { useToast } from "@/hooks/use-toast"

const briefingDataByDate = {
  "2024-09-05": {
    report_at: "2024년 9월 5일",
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-semibold text-gray-900 mb-2">브리핑을 찾을 수 없습니다</h1>
          <p className="text-gray-600">요청하신 날짜의 브리핑 데이터가 존재하지 않습니다.</p>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-semibold text-gray-900">K-Intelligence 조간 브리핑</h1>
              <p className="text-gray-600 mt-1">{briefingData.report_at} 언론 동향 분석 보고서</p>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-4 gap-6 mb-8">
          <Card className="border-gray-200">
            <CardContent className="p-6">
              ...
              <div className="text-2xl font-semibold text-gray-900 mb-1">{briefingData.stats.total}</div>
          ...
          <Card className="border-gray-200">
            <CardContent className="p-6">
              ...
              <div className="text-2xl font-semibold text-gray-900 mb-1">{briefingData.stats.positive}</div>
          ...
          <Card className="border-gray-200">
            <CardContent className="p-6">
              ...
              <div className="text-2xl font-semibold text-gray-900 mb-1">{briefingData.stats.caution}</div>
          ...
          <Card className="border-gray-200">
            <CardContent className="p-6">
              ...
              <div className="text-2xl font-semibold text-gray-900 mb-1">{briefingData.stats.sources}</div>
        ...
        <div className="space-y-8">
            ...
            <CardHeader className="pb-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>{briefingData.report_at} 조간 보고</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-gray-200">
            <CardHeader className="pb-4">
              <CardTitle className="text-lg font-semibold">주요 언론 보도 ({briefingData.report_at} 조간)</CardTitle>
              <CardDescription>
                보도 건수: 총 {briefingData.articles.reduce((sum, cat) => sum + cat.count, 0)}건
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              {briefingData.articles.map((category, index) => (
                    ...
                    {category.sources.map((source, sourceIndex) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-sm text-gray-700">"{source.title}" 외</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <span className="text-sm text-gray-600">(총 {source.count}건)</span>
                          <Button
                            variant="ghost"
                            size="sm"
