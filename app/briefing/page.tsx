        ...
        <div className='flex items-center justify-between mb-6'>
          ...
          <div className='flex items-center gap-3'>
            <DropdownMenu>
              ...
              <DropdownMenuContent>
                <DropdownMenuItem onClick={() => setSelectedDate('2025-09-05')}>
                  2025년 9월 5일
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setSelectedDate('2025-09-08')}>
                  2025년 9월 8일
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setSelectedDate('2025-09-09')}>
                  2025년 9월 9일
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
            ...
            <CardHeader className='pb-4'>
              <div className='flex items-center justify-between'>
                <div>
                  ...
                  <CardDescription>
                    {formatDateForDisplay(briefingData.date)} 조간 보고
                  </CardDescription>
                </div>
                <Button
                  variant='outline'
          ...
          <Card className='border-gray-200'>
            ...
            <CardContent className='p-0'>
              <div className='space-y-0'>
                {['2025-09-09', '2025-09-08', '2025-09-05'].map(date => (
                  <div
                    key={date}
