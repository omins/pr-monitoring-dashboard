...
const recentLogs: RecentLog[] = [
  {
    time: '10:48:32',
    level: 'INFO',
    message: '네이버 뉴스 API 연결 성공',
    workflow: '네이버 뉴스 모니터링',
  },
  {
    time: '10:47:15',
    level: 'SUCCESS',
    message: '키워드 매칭 완료 (127건 처리)',
    workflow: '키워드 매칭',
  },
  {
    time: '10:45:22',
    level: 'WARNING',
    message: '응답 시간 지연 감지 (3.2초)',
    workflow: '위험도 분석',
  },
  {
    time: '10:43:08',
    level: 'ERROR',
    message: 'RSS 피드 접근 실패',
    workflow: '언론사 RSS 수집',
  },
  {
    time: '10:41:55',
    level: 'INFO',
    message: '조간 브리핑 PDF 생성 완료',
    workflow: '조간 브리핑 생성',
  },
];
