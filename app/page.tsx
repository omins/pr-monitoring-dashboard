...
const crisisAlerts: CrisisAlert[] = [
  {
    ...
    key_sentence:
      '7월 KISA는 화이트해커 한 명의 제보를 통해 KT의 내부 데이터가 유출됐다는 사실을 파악했다.',
    action_plan:
  ...
  },
  {
    ...
    reason:
      '요금 인상에 대한 부정적 여론 확산으로 브랜드 이미지 타격 및 고객 불만 증가 예상됩니다.',
    key_sentence:
      'KT를 비롯한 통신 3사의 요금 인상이 서민 경제에 부담을 가중시킨다는 비판이 거세지고 있다.',
    action_plan:
  ...
  },
  {
    ...
    reason:
      '5G 서비스 품질에 대한 지속적인 문제 제기로 기술력 및 서비스 신뢰도에 부정적 영향을 미칠 수 있습니다.',
    key_sentence:
      'KT 5G 서비스 이용자들이 연결 불안정 및 속도 저하 문제를 지속적으로 호소하고 있다.',
    action_plan:
