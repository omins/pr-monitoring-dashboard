    ...
    categories: [
      {
        ...
        articles: [
          ...
          { title: "디지털 전환 투자 확대", source: "매일경제", url: "https://mk.co.kr/article/1", count: 13 },
        ],
      },
      {
        name: "일반 기사",
        count: 12,
        articles: [
          { title: "기업 사회공헌 활동 확대", source: "조선일보", url: "https://chosun.com/article/1", count: 6 },
          { title: "친환경 경영 실천", source: "중앙일보", url: "https://joongang.co.kr/article/1", count: 6 },
        ],
      },
      {
        name: "업계 동향",
        count: 8,
        articles: [
          { title: "업계 전반 성장세", source: "서울경제", url: "https://sedaily.com/article/1", count: 4 },
          { title: "경쟁사 동향 분석", source: "이데일리", url: "https://edaily.co.kr/article/1", count: 4 },
        ],
      },
    ],
    ...
    categories: [
      {
        ...
        articles: [
          ...
          { title: "해외 진출 로드맵 공개", source: "매일경제", url: "https://mk.co.kr/article/2", count: 11 },
        ],
      },
      {
        name: "일반 기사",
        count: 10,
        articles: [
          { title: "CEO 인터뷰 - 미래 비전", source: "조선일보", url: "https://chosun.com/article/2", count: 5 },
          { title: "직원 복지 개선 소식", source: "중앙일보", url: "https://joongang.co.kr/article/2", count: 5 },
        ],
      },
      {
        name: "업계 동향",
        count: 6,
        articles: [
          { title: "글로벌 시장 진출 트렌드", source: "서울경제", url: "https://sedaily.com/article/2", count: 3 },
          { title: "업계 리더십 평가", source: "이데일리", url: "https://edaily.co.kr/article/2", count: 3 },
        ],
      },
    ],
    ...
    categories: [
      {
        ...
        count: 24,
        articles: [
          { title: "신기술 특허 출원 완료", source: "한국경제", url: "https://hankyung.com/article/3", count: 12 },
          { title: "ESG 경영 우수 기업 선정", source: "매일경제", url: "https://mk.co.kr/article/3", count: 12 },
        ],
      },
      {
        name: "일반 기사",
        count: 11,
        articles: [
          { title: "지역사회 상생 프로그램", source: "조선일보", url: "https://chosun.com/article/3", count: 6 },
          { title: "청년 일자리 창출 기여", source: "중앙일보", url: "https://joongang.co.kr/article/3", count: 5 },
        ],
      },
      {
        name: "업계 동향",
        count: 7,
        articles: [
          { title: "ESG 투자 확산 현황", source: "서울경제", url: "https://sedaily.com/article/3", count: 4 },
          { title: "기술혁신 경쟁 심화", source: "이데일리", url: "https://edaily.co.kr/article/3", count: 3 },
        ],
      },
    ],
...
export const mockCrisisAlerts: CrisisAlert[] = [
  {
    ...
    key_sentence: "업계 전반의 품질 관리 시스템에 대한 재점검이 필요하다는 지적이 나오고 있다.",
    action_plan:
  ...
  },
  {
    ...
    reason: "새로운 규제가 도입될 경우 당사 사업 운영에 제약이 생길 수 있어 투자자들의 우려를 불러일으킬 수 있습니다.",
    key_sentence: "정부는 관련 업계에 대한 규제 강화 방안을 검토 중인 것으로 알려졌다.",
    action_plan: "규제 변화에 대한 당사의 대응 계획과 준비 상황을 투명하게 공개하여 시장의 불안감을 해소해야 합니다.",
    created_at: "2024-09-09T11:15:00Z",
    status: "monitoring",
  },
  {
    id: "3",
    ...
    key_sentence: "업계 전문가들은 올해 하반기 시장 성장률이 예상보다 높을 것으로 전망한다고 밝혔다.",
    action_plan:
      "업계 성장 트렌드 속에서 당사의 경쟁 우위와 성장 계획을 부각시키는 후속 보도를 추진하는 것이 좋겠습니다.",
    created_at: "2024-09-09T09:45:00Z",
    status: "resolved",
  },
]
...
export const mockSystemStatus: SystemStatus[] = [
  {
    ...
    value: 98.5,
    status: "normal",
    last_updated: "2024-09-09T15:00:00Z",
  },
  {
    id: "2",
    metric: "AI 분석 정확도",
